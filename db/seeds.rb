...
person18 = User.create!(email: "harriett@gmail.com", password: "123456", first_name: "Harriet", last_name: "Bullough", gender: "female", level: "intermediate", age: 26, location: "Hackney, London", bouldering:true, sport_climbing:true)

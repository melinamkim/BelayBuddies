...
person17 = User.create!(email: "todd@gmail.com", password: "123456", first_name: "Todd", last_name: "Neale", gender: "male", level: "beginner", age: 29, location: "Burngreave, Sheffield", bouldering:true, sport_climbing:true)
